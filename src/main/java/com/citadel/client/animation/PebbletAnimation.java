package com.citadel.client.animation;
...
public class PebbletAnimation {
    ...
    public static final AnimationDefinition ROLL_UP = AnimationDefinition.Builder.withLength(0.5F)
            ...
            .addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.5F, KeyframeAnimations.posVec(-5.0F, 1.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
    ...
    public static final AnimationDefinition ROLL_OUT = AnimationDefinition.Builder.withLength(0.5F)
            .addAnimation("root", new AnimationChannel(AnimationChannel.Targets.POSITION,
